/*
The purpose of this header file is to define a custom dynamic array structure for use in the engine.
*/
#pragma once
...
#define get_array_length(arr) _get_array_field(arr, ARRAY_LENGTH)
#define get_array_size(arr) _get_array_field(arr, ARRAY_SIZE)
#define get_array_step(arr) _get_array_field(arr, ARRAY_STEP)
...
BILT_API void *_resize_array(void *arr);
